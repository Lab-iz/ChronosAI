...
def default_curriculum() -> list[CurriculumStage]:
    return [
        ...
        CurriculumStage(name="simplified_sistema_solar", min_bodies=4, max_bodies=6, num_samples=128),
        CurriculumStage(name="especialista_real", min_bodies=3, max_bodies=3, num_samples=64),
    ]
